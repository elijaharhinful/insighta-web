  ...
  const handleSearch = async (e?: React.FormEvent, pageNum = 1) => {
    ...
    try {
      const res = await api.get(
        `/api/profiles/search?q=${encodeURIComponent(query)}&page=${pageNum}&limit=10`,
      );
      ...
      <div className="flex flex-col items-center text-center">
        ...
        >
          ...
          <Button
            ...
            className="absolute right-2 h-12 rounded-full bg-violet-600 px-6 font-semibold text-white hover:bg-violet-700 dark:bg-violet-600 dark:text-white dark:hover:bg-violet-700"
          >
        ...
        <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex items-center justify-between">
            ...
            <p className="text-sm text-zinc-500">
              {profiles.length} result{profiles.length !== 1 && "s"} on this
              page
            </p>
          </div>
              ...
              <TableBody>
                {loading ? (
                  ...
                  <TableRow>
                    ...
                    >
                      No matching profiles found for your query. Try rephrasing
                      it.
                    </TableCell>
                  </TableRow>
                ) : (
